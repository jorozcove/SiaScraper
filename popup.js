        ...
        if (itemsArr.length == 0) {
            itemsList.innerHTML =
                `<div class="d-flex justify-content-center">
                    <div>
                        <p class="text-center fw-bold">Agrega asignaturas desde el catálogo</p>
                        <p class="text-center small fst-italic">Nota: Si los grupos aun no están actualizados en el catálogo se recomienda ir a "Asignaturas ofertadas por cursar" en el SIA</p>
                    </div>
                    <br></br>
                </div>`
        }
